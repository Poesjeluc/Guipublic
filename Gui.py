...
def buttonEqual():
    global operator
    restult = str(eval(operator))
    input_value.set(restult)
    operator = ""
...
btn_is = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="=",command=buttonEqual)
btn_is.grid(row=4,column=2)
